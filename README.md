...
I have experience with web, mobile, and desktop development technologies:
...
[![Microsoft SQL Server](https://img.shields.io/badge/Microsoft_SQL_Server-CC2927?logo=microsoft%20sql%20server&logoColor=white)](#) 
...
- [MoviVerse:](https://fredy034.neocities.org/MovieVerse/index.html) MovieVerse is a leading movie application crafted using the TMDb API to provide comprehensive movie information and entertainment.
- [Code Journey:](https://codejourney.netlify.app/) A mobile application that provides users with a platform to learn and practice programming languages, offering a wide range of challenges.

## Education & Experience

- **Degree in Computer Engineering** – Institución Universitaria de Envigado (IUE)
- **Software Analyst** – Compuhora S.A.S. (Remote)
- **IT Architecture Intern** – Postobón S.A. (On-site, completed)
- **Courses & Certifications:** Angular, .NET Core, SQL, Responsive Design, Cybersecurity, HTML & CSS, Git & GitHub, CCNA.
